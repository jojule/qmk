...
static const uint16_t ghost1_row3_z =           0B0000000000010000;
static const matrix_row_t ghost1_row3_correct = 0B0000100000000000;

void fix_ghosting_issue(matrix_row_t current_matrix[]) {
    if (current_matrix[1] == ghost1_row2) {
        if (current_matrix[2] == ghost1_row3 || 
                current_matrix[2] == (ghost1_row3 | ghost1_row3_z)) {
            current_matrix[2] = ghost1_row3_correct | 
                (current_matrix[2]&ghost1_row3_z);
        }
    }
}
