...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x5_3(
	    KC_TILD, KC_GRV, KC_PIPE, KC_BSLS, KC_NO, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, 
	    CW_TOGG, KC_NO, KC_BTN2, KC_BTN1, KC_NO, KC_WH_U, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, 
	    KC_TRNS, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, CKC_APP_SWITCH, KC_HOME, KC_PGDN, KC_PGUP, KC_END, 
	    KC_TRNS, KC_TRNS, KC_TRNS, 
